...
const Items = () => {
  ...
  return ( 
    <div className="wrapper">
      ...
      <p className="d-flex justify-content-center">|<div className="baw">Tickets that has already booked</div>|</p>
      <div className="main">
        ...
        <div className="form-container">
          <form className="form-group" action="" autoComplete="off" onSubmit={handleAddItems}>
            ...
            <div className="d-flex justify-content-center"><button className="add-btn" type="submit"> Add item</button></div>
          </form>
        </div>
